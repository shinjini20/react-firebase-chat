  ...
  const handleSend = async () => {
    ...
    try{
      ...
      userIDs.forEach(async (id) => {
        ...
        //gets the chat data of the currentUser
        const userChatsSnapshot = await getDoc(userChatsRef);

        if(userChatsSnapshot.exists()){
          const userChatsData = userChatsSnapshot.data();
          //find the text sent by currentUser using chatId
          const chatIndex = userChatsData.chats.findIndex(c=> c.chatId === chatId)

          //updating lastMessage, isSeen and updatedAt fields
          userChatsData.chats[chatIndex].lastMessage = text;
          userChatsData.chats[chatIndex].isSeen = id === currentUser.id ? true : false;
          //shows the latest message first
  ...
  return (
    <div className="chat">
      ...
      <div className="bottom">
        ...
        <input type="text" placeholder={isCurrentUserBlocked || isReceiverBlocked ? "You cannot send a message" : "Type a message..."} value ={text}
